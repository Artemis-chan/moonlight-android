...
public class KeyboardTranslator implements InputManager.InputDeviceListener {
    ...
    {
        final String name = KeyEvent.keyCodeToString(keycode).replaceFirst("KEYCODE_", "")
                .replaceFirst("_LEFT", "←")
                .replaceFirst("_RIGHT", "→")
                .replaceFirst("_UP", "↑")
                .replaceFirst("_DOWN", "↓")
     ...
     */
    public static short translateKeycode(int keycode) {
        int translated;
    ...
    /**
     * Translates the given keycode and returns the GFE keycode based on deviceId
     * @param keycode the code to be translated
